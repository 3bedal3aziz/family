      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-3 col-md-6 col-sm-6">
            ...
            <Image src={logo} width={`450px`} height={`450px`} alt="logo" priority    /></a>    
              <p>احجز واستلم شجرة عائلتك    المميزة من تطبيقنا</p>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <div className="widget course-links-widget">
              ...
              <ul className="courses-link-list">
                <li><a href="#"><i className="fas fa-long-arrow-alt-right"></i>حسب ونسب</a></li>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <div className="widget newsletter-widget">
              <h5 className="widget-title">لا تتردد في الاتصال بنا</h5>
      ...
      <div className="container">
        <div className="row">
            <div className="col-md-6 col-sm-6 text-sm-left text-center ">
              <span className="copy-right-text fw-bold" >© 2023 <a href="#">حسب ونسب</a> جميع الحقوق محفوظة.</span>
            </div>
            <div className="col-md-6 col-sm-6 ">
              <ul className="terms-privacy d-flex justify-content-sm-end justify-content-center text-dark fw-bold">
                <li><a href="#">البنود والشروط</a></li>
